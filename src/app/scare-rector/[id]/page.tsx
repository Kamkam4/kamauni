        ...
        <div className="max-w-2xl mx-auto text-center">
          <div className="bg-white rounded-lg shadow-2xl p-8">
            ...
            <h1 className="text-3xl font-bold text-green-600 mb-4">
              გილოცავთ! დერეხტორი შეშინდა!
            </h1>
            <p className="text-gray-600 mb-6">
              თქვენი დარტყმები იმდენად სერიოზული იყო, რომ დერეხტორმა გადაწყვიტა დიპლომი მოგცეთ და ყველა საგანში უმაღლესი შეფასება დაგიწეროთ!
            </p>
            <button
              onClick={getDiploma}
          ...
          <div className="text-center">
            ...
            <div className="text-center mb-6">
              ...
              <div className="mt-4 text-sm text-gray-600">
                {!isScared ? (
                  <p>დაარტყი დერეხტორს რომ შეშინდეს! ({clickCount} დარტყმა)</p>
                ) : (
            ...
            <p className="text-gray-600 mb-6">
              {isScared
                ...
                : 'დაარტყი დერეხტორს რამდენჯერაც გინდა! რაც უფრო მეტჯერ დაარტყამ, მით უფრო სწრაფად შეივსება პროგრესის ზოლი.'
              }
            </p>
          </div>
        </div>
